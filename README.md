### Home Delivery App of Grocery,Medicines,Vegetables,etc during lockdown.Client can send Handwritten List Photo 📸,Chat with Shopkeeper 📱,or can call Shopkeeper 📞.
